...
const Index = () => {
  ...
  useEffect(() => {
    ...
    scene.background = new THREE.Color("#2B2929");
    ...
    loadExternalModels(scene, camera, "");
  ...
  const loadExternalModels = (scene, camera, path, ) => {
    console.log("Step 1");
    const loader = new GLTFLoader();
    loader.load( 'green_dress.glb',  ( gltf ) => {
      console.log("Step 3");
      gltf.scene.scale.set(0.001, 0.001, 0.001);
      gltf.scene.position.set(camera.position.x-0.2, camera.position.y-0.05, camera.position.z-0.2);
    ...
    loader.load( 'blue_dress.glb',  ( gltf ) => {
      console.log("Step 4");
      gltf.scene.scale.set(0.001, 0.001, 0.001);
      gltf.scene.position.set(camera.position.x-0.2, camera.position.y-0.05, camera.position.z-0.5);
      gltf.scene.rotateY = Math.PI/4;
      scene.add( gltf.scene );
    }, undefined, ( error ) => {
      console.error( error );
